(custom-set-variables
 ...
 '(safe-local-variable-values
   (quote
    ((python-shell-interpretor-args . "/home/alan/dev/eBill/manage.py shell")
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "Consolas" :foundry "outline" :slant normal :weight normal :height 115 :width normal)))))
